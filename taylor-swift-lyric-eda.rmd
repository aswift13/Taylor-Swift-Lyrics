...
The data cleaning process began with SAS and ended with R filtering the lyrics data. 
...
Stop words and other non-unique or non-sentient associated words were removed. These stop words were attained from the tidytext package with its stop words data set. These stop words were matched and given a value of 1 if the word is associated with the sentiment or 0 if it is not. They were then accumulated and given a count number. Words not a part of the stop words were removed manually. 
...
sentot1 <- bind_rows(sent1a,sent5a,sent8a)
